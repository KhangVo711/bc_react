...
export default function Cart() {
    ...
    const { cart, increaseQuantity, decreaseQuantity, removeItem, setCart } = useContext(Context);
    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center">
            ...
            <div className="w-full flex flex-col items-center justify-center">
                ...
                <button onClick={() => {setStatus(true); setCart([])}} className="text-white bg-blue-500 px-4 py-2 rounded-md mt-4">Đặt hàng</button>
            </div>
}
        </div>
